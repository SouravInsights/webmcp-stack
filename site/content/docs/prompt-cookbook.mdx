...
<Callout type="warn">
  Read the diff before you accept it, and do not let an agent enable a write on
  its own. Enabling a write is a human decision about what a model may do while
  acting as your user.
</Callout>
