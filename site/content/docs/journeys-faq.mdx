...
nesting, and any step can write any field. One caveat: if two steps use the same
field name, the second silently overwrites the first. Avoiding that is on
whoever writes the journey.
